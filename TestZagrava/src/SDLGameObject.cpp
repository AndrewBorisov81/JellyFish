...
{
  TextureManager::Instance()->drawFrame(m_textureID, (int)m_position.getX(), (int)m_position.getY(), m_width, m_height, m_angleRotation, m_currentRow, m_currentFrame, TheGame::Instance()->getRenderer());
}
